...
public:
    ...
    torch::stable::Tensor get_local_buffer_tensor(torch::headeronly::ScalarType dtype, int64_t offset, bool use_rdma_buffer) const;

    void destroy();

    std::tuple<torch::stable::Tensor, std::optional<torch::stable::Tensor>, torch::stable::Tensor, torch::stable::Tensor, int64_t>
    get_dispatch_layout(const torch::stable::Tensor &topk_idx, int num_experts, const EventHandle *previous_event,
    ...
    ht_dispatch(const torch::stable::Tensor &x, const std::optional<torch::stable::Tensor> &x_scales,
    ...
    ht_combine(const torch::stable::Tensor &x, const std::optional<torch::stable::Tensor> &topk_weights,
    ...
    dispatch(const torch::stable::Tensor &x, const torch::stable::Tensor &topk_idx,
    ...
    combine(const torch::stable::Tensor &x, const torch::stable::Tensor &topk_idx, const torch::stable::Tensor &topk_weights,
